...
const toggler = document.querySelector(".toggler-btn");
   ...
   function showSection(section) {
    ...
    const sectionMap = {
        'home': 'pages/overseer/home.html',
        'system-authority': 'pages/overseer/system-authority.html',

        // Content Management
        'manage-programs': 'pages/overseer/manage-programs.html',
        'manage-announcement': 'pages/overseer/manage-announcement.html',
        'manage-accreditation': 'pages/overseer/manage-accreditation.html',
        'event-expenses': 'pages/overseer/event-expenses.html',

        // Organization
        'org-fees': 'pages/overseer/organization-fees.html',
        'membership-fee': 'pages/overseer/membership-fee.html',
        'records': 'pages/overseer/records.html',
        'clubs': 'pages/overseer/clubs.html',

        // Others
        'academic-terms': 'pages/overseer/manage-academic-terms.html',
        //'e-voting': 'pages/overseer/e-voting.html' --remove comment if you want to add this function
    };
    ...
    fetch(fileName)
        ...
        if (section === 'system-authority' && window.SystemAuthority?.init) {
            window.SystemAuthority.init();
        }
